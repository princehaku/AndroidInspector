...
cd buildTools\7z
7z.exe a -r -tzip %NWZIP_PATH% ..\..\src\*
cd ..\..
...
echo.
if not exist %CUR_DIR%\release\ffmpegsumo.dll copy %CUR_DIR%\nw-windows\ffmpegsumo.dll %CUR_DIR%\release\ffmpegsumo.dll
if not exist %CUR_DIR%\release\icudt.dll copy %CUR_DIR%\nw-windows\icudt.dll %CUR_DIR%\release\icudt.dll
if not exist %CUR_DIR%\release\libEGL.dll copy %CUR_DIR%\nw-windows\libEGL.dll %CUR_DIR%\release\libEGL.dll
if not exist %CUR_DIR%\release\libGLESv2.dll copy %CUR_DIR%\nw-windows\libGLESv2.dll %CUR_DIR%\release\libGLESv2.dll
